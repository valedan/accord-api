import {
  isGreaterThanStep, isIfStep, isLengthStep, isWaitStep, Step, WorkflowParams
} from "../../types";
...
const paramsForStep = (workflowParams: WorkflowParams, previousStepOutput: StepOutput) => {
  return {
    ...workflowParams,
...
const runSteps = async (steps: Step[] = [], params: WorkflowParams) => {
